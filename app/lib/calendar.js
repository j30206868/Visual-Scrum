...
// 设置日历面板div样式(设置高度)
$("<div class='fc-view fc-view-" + newViewName + "' style='position:absolute; height: 548px;'/>")
.appendTo(content),
...
// 设置日历块高度
for (i=0; i<rowCnt; i++) {
html += "<tr style='height: 88px;' class='fc-week'>";
...
slotScroller =
$("<div style='position:absolute;width:100%;overflow-x:hidden;overflow-y:auto; height: 530px;'/>")
.appendTo(slotLayer);
